...
public class ChatListPane {
	...
	public ChatListPane(UserDTO dto) {
		...
		pane.setBackground(new Background (new BackgroundFill(Color.rgb(252, 246, 245), CornerRadii.EMPTY, Insets.EMPTY)));
		//pane.setBackground(new Background (new BackgroundFill(Color.rgb(123, 154, 204), CornerRadii.EMPTY, Insets.EMPTY)));
