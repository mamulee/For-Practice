	...
	<article id="signup" class="panel secondary">
		...
		<div class="content">
			...
			<div class="inner">
				...
				<form name="signUpForm" method="post" action="${pageContext.request.contextPath}/member/MemberSignUpAction.me">
					<div class="fields">
						<div class="field half">
							...
							<textarea id="idCheck" rows="1" cols="1" style="resize:none; outline:none; border:none; background:white; text-align:right;" readonly></textarea>
							<br>
							<label for="pw">Password</label>
							<input type="password" name="memberPw" id="pw" />
							<br>
							<label for="pw-check">Password Check</label>
							<input type="password" name="memberPwCheck" id="pw-check" />
							...
							<ul class="actions" style="margin-bottom:0; width:100%;">
								<li style="width:100%;"><a href="javascript: sendEmail()" id="memberEmailVer" class="button disable" style="width:100%; margin-top:1em;">인증 번호 발송</a></li>
							</ul>
							<input type="text" name="memberEmailCheck" id="email-confirm" placeholder="인증 번호 입력" style="display:none; text-align:center" />
							<textarea id="emailCheck" rows="1" cols="1" style="resize:none; outline:none; border:none; background:white; text-align:right;" readonly></textarea>
							<br>
						</div>
						<div class="field">
							<label for="message">가입 약관</label>
							<textarea name="message" id="message" rows="5" style="resize:none" readonly>
시행일자 : 2020년 11월 16일
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
						...
						<ul class="actions stacked special animated spinY" style="margin-top: 50px;">
							<li>
								<input type="button" onclick="formSubmit()" value="Sign Up" class="button primary" style="float:left;"/>
